...
ship1 = Ship.create!(name: "CR90 corvette", model: "CR90 corvette", cost: "3500000", length: "150", atmospheric_speed: "950", crew: "30-165", passengers: "600", user: user)
...
ship2 = Ship.create(name: "Star Destroyer", model: "Imperial I-class Star Destroyer", cost: "150000000", length: "1,600", atmospheric_speed: "975", crew: "47,060", passengers: "n/a", user: user)
...
ship3 = Ship.create(name: "Sentinel-class landing craft", model: "Sentinel-class landing craft", cost: "240000", length: "38", atmospheric_speed: "1000", crew: "5", passengers: "75", user: user)
...
ship4 = Ship.create(name: "Death Star", model: "DS-1 Orbital Battle Station", cost: "1000000000000", length: "120000", atmospheric_speed: "n/a", crew: "342,953", passengers: "843,342", user: user)
...
ship5 = Ship.create(name: "Millennium Falcon", model: "YT-1300 light freighter", cost: "100000", length: "34.37", atmospheric_speed: "1050", crew: "4", passengers: "6", user: user)
...
ship6 = Ship.create(name: "Y-wing", model: "BTL Y-wing", cost: "134999", length: "14", atmospheric_speed: "1000", crew: "2", passengers: "0", user: user)
...
ship7 = Ship.create(name: "X-wing", model: "T-65 X-wing", cost: "149999", length: "12.5", atmospheric_speed: "1050", crew: "1", passengers: "0", user: user)
...
ship8 = Ship.create(name: "Executor", model: "Executor-class star dreadnought", cost: "1143350000", length: "19000", atmospheric_speed: "n/a", crew: "279,144", passengers: "3800", user: user)
...
ship9 = Ship.create(name: "Rebel transport", model: "GR-75 medium transport", cost: "550", length: "90", atmospheric_speed: "650", crew: "6", passengers: "90", user: user)
...
# ship10 = Ship.create(name: "Slave 1", model: "Firespray-31-class patrol and attack", cost: "482,394", length: "21.5", atmospheric_speed: "1000", crew: "1", passengers: "6", user: user)
